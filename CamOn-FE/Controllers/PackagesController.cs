...
namespace CamOn_FE.Controllers
{
    public class PackagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,MonthValue,CameraValue,Price,Id")] Package package)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,MonthValue,CameraValue,Price,Id")] Package package)
        {
            if (id != package.Id)
            {
                return NotFound();
