...
namespace CamOn_FE.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        private BusinessObjects.Account CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(BusinessObjects.Account)}'. " +
                    $"Ensure that '{nameof(BusinessObjects.Account)}' is not an abstract class and has a parameterless constructor, or alternatively " +
